...
export const P0_TOOLS: ToolDef[] = [
  ...
  t(
    ...
    "Add names or choices, spin, get one winner. crypto.getRandomValues in this tab. Nothing is uploaded.",
    ["spin the wheel", "random wheel picker", "decision wheel", "wheel of names"],
    [
      { q: "Is it fair?", a: "Each slice has equal chance. The index is picked with crypto.getRandomValues, then the wheel animates to that slice." },
  ...
  t(
    ...
    "Flip a fair coin in this tab. crypto.getRandomValues. No account.",
    ["coin toss", "flip a coin", "heads or tails", "toss a coin"],
    [{ q: "True random?", a: "Cryptographic RNG from the browser. Not a hardware entropy source, and not a trick coin." }],
