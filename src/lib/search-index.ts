...
const PAGES: Array<{ href: string; title: string; lede: string; keywords: string }> = [
  ...
  { href: "/tools", title: "All tools", lede: "Compress, PDF, OCR, QR, URL media, color, time zones, UUID, Wi‑Fi speed test, document photos.", keywords: "inventory tools pdf ocr qr url downloader youtube thumbnail wcag est gmt uuid wifi speed test" },
