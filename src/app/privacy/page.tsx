  ...
  return (
    <article className="container-page prose-site max-w-3xl py-16">
      ...
      <p>
        ...
        file-upload API. The Wi‑Fi speed-test page times generated bytes
        against Cloudflare’s public speed-test host; it does not send your
        photos or PDFs. The ATS resume builder stores a draft in this browser
        only. The URL media tool may fetch a public URL you pasted
        (with SSRF blocks), including a public video or image file at that
        address; it does not rip DRM or private accounts.
      </p>
      <h2>Children</h2>
      <p>
